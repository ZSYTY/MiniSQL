...
//    }
    ...
    tableInfo1.tableName = "Test";
    tableInfo1.columnCnt = 3;
//    tableInfo1.columnType[0].type = SqlValueBaseType::MiniSQL_char;
//    tableInfo1.columnType[1].type = SqlValueBaseType::MiniSQL_int;
//    tableInfo1.columnType[2].type = SqlValueBaseType::MiniSQL_float;
    SqlValueType *sqlValueType1 = new SqlValueType(SqlValueBaseType::MiniSQL_char,false,false,10);
    SqlValueType *sqlValueType2 = new SqlValueType(SqlValueBaseType::MiniSQL_int,false,false,0);
    SqlValueType *sqlValueType3 = new SqlValueType(SqlValueBaseType::MiniSQL_float,false,false,0);
    tableInfo1.columnType.push_back(*sqlValueType1);
    tableInfo1.columnType.push_back(*sqlValueType2);
    tableInfo1.columnType.push_back(*sqlValueType3);
    tableInfo1.columnName.emplace_back("Name");
    tableInfo1.columnName.emplace_back("Number");
    tableInfo1.columnName.emplace_back("Score");
    tableInfo1.recordCnt = 5;
    return tableInfo1;
}
